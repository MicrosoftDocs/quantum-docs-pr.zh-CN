...
## <a name="importing-required-powershell-modules"></a><span data-ttu-id="7b6d9-113">导入所需的 PowerShell 模块</span><span class="sxs-lookup"><span data-stu-id="7b6d9-113">Importing Required PowerShell Modules</span></span> ##
