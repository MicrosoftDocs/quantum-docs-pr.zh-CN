...
以 <xref:Microsoft.Quantum.Canon.ApplyToEachCA> 和数组操作函数（如）表示， <xref:Microsoft.Quantum.Arrays.Zipped> 但这更简短且更易于阅读：
...
### <a name="time-ordered-composition"></a>Time-Ordered 组合 ###
